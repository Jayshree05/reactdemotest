      ...
      return (
        <View>
          <View
            ...
            <ImageBackground
              source={{
                uri: 'https://i.picsum.photos/id/566/536/354.jpg?hmac=Qe2MWolacWFJhNfFjmrRRPCdvD0fOtwXEsq_f53gkic',
              }}
              style={styles.image}>
            ...
            <View
              ...
              <View
                style={{
                  flex: 1,
                  backgroundColor: 'rgba(69,80,17,0.9)',
                  padding: 3,
                }}>
                <Text>hiiii</Text>
              </View>
  ...
  render() {
    return (
      <View style={styles.full_container}>
        ...
        <ScrollView horizontal>{this.allMembers()}</ScrollView>
      </View>
    );
  }
}
